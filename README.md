...
Built on **Circle's Arc mainnet**, settled in **USDC**, funded with **passkeys** and **no gas fees**.
...
| Passkey wallets + gasless transactions | ✅ Live | Self-custodial ERC-4337 + Gas Station. |
...
5. In the Circle console, enable a Gas Station policy for Arc (sponsors contributions) and add the production domain to the client key's allowed domains.
