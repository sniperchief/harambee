...
export default async function DashboardPage() {
  ...
  const counts = await getContributorCounts(supabase, created.map((p) => p.id));
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-8 lg:col-span-2">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <StatCard
                label="Earning yield"
                value={activeCount > 0 ? "On" : "—"}
                sub="Idle funds grow in escrow"
                icon={<LeafIcon />}
                tone="success"
                size="lg"
              />
